export default function TrustCta({ data }) {
  ...
  return (
    <section style={{ paddingBottom: 8 }}>
      ...
      {data.ctaButton && (
        <p>
          <a href={data.ctaButton.href} dangerouslySetInnerHTML={{ __html: data.ctaButton.label }} />
          {data.ctaButton.note && <> — <span dangerouslySetInnerHTML={{ __html: data.ctaButton.note }} /></>}
        </p>
      )}
      <hr />
    </section>
