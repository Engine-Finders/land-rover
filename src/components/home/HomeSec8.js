    ...
    >
      ...
      <span className="flex min-w-0 flex-1 items-center gap-3 px-3 py-3 md:gap-4 md:px-4 md:py-3.5">
        ...
        <span className="min-w-0 flex-1">
          ...
          <span className={`mt-1 block text-[0.74rem] font-normal leading-[1.35] md:text-[0.8rem] ${isDark ? "text-white/68" : "text-[var(--color-text-muted)]"}`}>
            {item.description}
          </span>
        </span>
...
export default function HomeSec8({ data, band = "page" }) {
